...
var pizzaElementGenerator = function(i) {
	...
	// Improve PageSpeed score by providing a height and width. TB
...
// Instantiate an array to hold our resizable pizzas.
var resizable_containers = [];

// resizePizzas(size) is called when the slider in the "Our Pizzas" section of the website moves.
var resizePizzas = function(size) {
	if (resizable_containers.length === 0) {
		resizable_containers = document.querySelectorAll(".randomPizzaContainer");
	}
	...
	function changePizzaSizes(size) {
		...
		var dx = determineDx(resizable_containers[1], size);
		var newwidth = (resizable_containers[1].offsetWidth + dx) + 'px';
		for (var i = 0; i < resizable_containers.length; i++) {
			resizable_containers[i].style.width = newwidth;
		}
	}
